/* @ts-self-types="./orbital_wasm.d.ts" */
 ...
 * @returns {number}
 */
export function benchmark_generation(n, l, m, num_particles, seed) {
    const ret = wasm.benchmark_generation(n, l, m, num_particles, seed);
    return ret;
}
 ...
 */
export function generate_orbital(n, l, m, num_particles, seed) {
    const ret = wasm.generate_orbital(n, l, m, num_particles, seed);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('orbital_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
